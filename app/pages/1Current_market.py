...
rsi_upper_BB = st.checkbox("Show Upper Bollinger Band", value=True)
rsi_middle_BB = st.checkbox("Show Middle Bollinger Band", value=True)
rsi_lower_BB = st.checkbox("Show Lower Bollinger Band", value=True)
